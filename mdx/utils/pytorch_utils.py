...
class Base:
    ...
    def spectrogram_phase(self, input: torch.Tensor, eps: float = 0.0) -> List[torch.Tensor]:
    ...
    def wav_to_spectrogram_phase(self, input: torch.Tensor, eps: float = 1e-10) -> List[torch.Tensor]:
    ...
    def wav_to_spectrogram(self, input: torch.Tensor, eps: float = 1e-10) -> List[torch.Tensor]:
